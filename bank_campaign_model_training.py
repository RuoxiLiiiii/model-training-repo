...
bucket = storage_client.bucket("mlops-429321_cloudbuild")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "mlops-429321.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlops-429321_cloudbuild/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
